...
public class MRumahSakit {
    public static void main(String[] args) {
        try {
            // Dokter dan Perawat (inheritance + overriding + interface)
            ...
            dokterMitra.printInfo();
            dokterMitra.printInfo(true); // overloading
            System.out.println();
            ...
            System.err.println("Data tidak valid: " + e.getMessage());
        } catch (AssertionError e) {
            System.err.println("Error assertion: " + e.getMessage());
        }
    }
}
