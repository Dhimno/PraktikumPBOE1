...
public class GUI extends javax.swing.JFrame {
    ...
    private int getSelectedIndexOrWarn() {
        ...
        if (index < 0) {
            JOptionPane.showMessageDialog(this, "Pilih item pada list terlebih dahulu.");
        }
        return index;
    }
    ...
    private List<String> getCurrentListSnapshot() {
        ...
        for (int i = 0; i < dlm.getSize(); i++) {
            snapshot.add(dlm.getElementAt(i));
        }
        return snapshot;
    }

    private void loadFromList(List<String> source) {
        dlm.clear();
    ...
    private void loadFromSet(Set<String> source) {
        dlm.clear();
        for (String item : source) {
            dlm.addElement(item);
        }
    ...
    private void loadFromMap(Map<Integer, String> source) {
        dlm.clear();
        for (String item : source.values()) {
            dlm.addElement(item);
        }
    }
    ...
    private void saveToList() {
        items.clear();
        items.addAll(getCurrentListSnapshot());
        updateJumDataTersimpan();
    }

    private void saveToSet() {
        itemsSet.clear();
        itemsSet.addAll(getCurrentListSnapshot());
        updateJumDataTersimpan();
    }

    private void saveToMap() {
        itemsMap.clear();
        List<String> snapshot = getCurrentListSnapshot();
        for (int i = 0; i < snapshot.size(); i++) {
            itemsMap.put(i, snapshot.get(i));
        }
        updateJumDataTersimpan();
    }
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                        .addComponent(jTextFieldItem, javax.swing.GroupLayout.PREFERRED_SIZE, 138, javax.swing.GroupLayout.PREFERRED_SIZE))
                    .addGroup(layout.createSequentialGroup()
                        .addComponent(jButtonSaveList, javax.swing.GroupLayout.PREFERRED_SIZE, 140, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                        .addComponent(jLabelJumlahList))
                    .addGroup(layout.createSequentialGroup()
                        .addComponent(jButtonSaveSet, javax.swing.GroupLayout.PREFERRED_SIZE, 140, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addGap(12, 12, 12)
                        .addComponent(jLabelJumlahSet))
                    .addGroup(layout.createSequentialGroup()
                        .addComponent(jButtonSaveMap, javax.swing.GroupLayout.PREFERRED_SIZE, 140, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addGap(12, 12, 12)
                        .addComponent(jLabelJumlahMap))
                    .addComponent(jButtonInsertList, javax.swing.GroupLayout.PREFERRED_SIZE, 140, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(jButtonInsertSet, javax.swing.GroupLayout.PREFERRED_SIZE, 140, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void jButtonDeleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonDeleteActionPerformed
        int index = getSelectedIndexOrWarn();
        if (index < 0) {
            return;
        }
